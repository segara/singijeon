...
namespace Singijeon
{
    ...
    class ConstName
    {
        ...
        public const string SEND_ORDER_ALL_SELL = "청산매도주문";
        public const string SEND_ORDER_BUY = "편입종목매수";
        public const string SEND_ORDER_SELL = "편입종목매도";
        ...
        public const string RECEIVE_TR_DATA_FOR_BUY_MORE = "매수종목정보요청";
    ...
    class StrategyItemName
    {
        ...
        public const string BUY_MORE_AND_PROFIT = "물타기후익절설정";
        public const string BUY_MORE_AND_STOPLOSS = "물타기후손절설정";
        ...
        public const string TAKE_PROFIT_DIVIDE_SELL = "매매전략_분할익절";
        public const string TAKE_PROFIT_TRAILING_SELL = "매매전략_익절트레일링";
        public const string BUY_TIME_LIMIT = "매매시간설정";
        public const string BUY_GAP_CHECK = "갭상승추격매수";
        public const string BUY_MORE_LOSS = "물타기";
        public const string BUY_MORE_PROFIT = "불타기";
